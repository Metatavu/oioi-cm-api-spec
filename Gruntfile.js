module.exports = function(grunt) {
  ...
  const JAXRS_ARTIFACT = "oioi-cm-api-spec";
  const JAXRS_PACKAGE = "fi.metatavu.oioi.cm.rest";
  const JAXRS_GROUP = "fi.metatavu.oioi.cm";
  const JAXRS_TARGET_FOLDER= JAXRS_PACKAGE.replace(/\./g, "/");
  const TYPESCRIPT_MODEL_PACKAGE = "oioi-cm-api-client";
  const TYPESCRIPT_MODEL_VERSION = require("./typescript-client-generated/package.json").version;
  const JAVA_ARTIFACT = "oioi-cm-api-client";
  const JAVA_PACKAGE = "fi.metatavu.oioi.cm.client";
  const JAVA_GROUP = "fi.metatavu.oioi.cm.client";
  ...
  grunt.initConfig({
    ...
    "clean": {
      "jaxrs-spec-cruft": [
        "jaxrs-spec-generated/src/main/java/fi/metatavu/oioi/cm/rest/RestApplication.java"
      ],
